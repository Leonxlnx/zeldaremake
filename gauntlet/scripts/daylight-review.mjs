...
try {
 ...
 await page.evaluateOnNewDocument(s=>{window.__ATMO_SKY__=s.sky;window.__ATMO_FOG__=s.fog;window.__ATMO_LIGHT__=s.light;},settings);
 ...
 for(const id of [...views,'sky-opening']) {
  await page.evaluate(async id=>{if(id==='sky-opening')__ZR__.setPose([0,1.8,.5],[0,18,-15],72);else if(!__ZR__.setViewpoint(id))throw Error('Unknown viewpoint');__ZR__.setTime(12.6);await __ZR__.render(2,0);},id);
