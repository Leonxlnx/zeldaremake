...
[Explicit request to Fable to confirm retained Verdant elements and provide current captures](https://github.com/Leonxlnx/zeldaremake/pull/2#issuecomment-5702295642). His previous replies confirm the daylight integration and identify crown breakup/lantern corridor as remaining work. Fable answered explicitly at18:41 UTC: [Verdant reuse breakdown](https://github.com/Leonxlnx/zeldaremake/pull/2#issuecomment-5702697973). Retained: tree primitives, white-bark birch, curved leaf geometry, veins/translucency and understory shapes. Not directly ported: the original near-leaf micro-normal fade (he implemented an equivalent), further species and Verdant volumetrics. Fresh published heada728d9cb seals take109 on0820f92. He reports round40 targeting lantern branches, near trunks, elevated crown breakup, roof moss and near vegetation. His close-up paths currently point to his cloud filesystem; accessible committed images have been requested. This confirms his stated plan and source reuse, not independent acceptance of all claimed visual improvements.
