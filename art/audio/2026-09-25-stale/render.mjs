#!/usr/bin/env node
/**
 * render.mjs — the boles route, rendered before and after.
 *
 *   node art/audio/2026-09-25-stale/render.mjs --dist dist --tag before [--out /tmp/parallax]
 *
...
const log = (...m) => console.error('[stale]', ...m);
