...
const dir = path.resolve(process.argv[2] || 'art/environment/astra-leaf-warmth/native-pair');
...
assert.equal(builds[0].sha, '0963c09da4139a0542a338d3345796dce6b20b8a');
assert.equal(builds[1].sha, '0858f39f75ee14130be7ff84692cdd33422c83ab');
