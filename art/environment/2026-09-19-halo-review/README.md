...
Full local take-0117 on5e468708 completed in138s: valid,93 anti-cheat checks green, zero determinism difference, placement checks100%, maximum521 draws /8.80M triangles. Score29/50 (Phase1 25/42) incorporates Fable-5's independent reviews; the score increase is not attributed to this halo change. This is local evidence, not CI exit attestation. Capture settling/time differ from the paired diagnostic, so compare SSIM only within each method. CI remains pending at this checkpoint.
