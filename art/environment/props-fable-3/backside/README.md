...
`09fc511e` / `3227a358` the marker moved off a bush and then west of C's shadow reach, and the
backside as its own merge locality culled by `util/expansionLocality.ts`).
...
appear and vanish together. 13 meshes for the system (village 5, clearing 4, backside 4).
...
third decimal — the six frames draw none of the backside in either pass. 0 console errors both
sides. (An earlier table against the older head `97c83227` showed D changing 9917 px: that was
