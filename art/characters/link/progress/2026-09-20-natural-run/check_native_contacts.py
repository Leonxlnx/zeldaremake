...
report = []
for label, name in [('before', 'Link | September20 natural run baseline'), ('after', 'Link | September20 clear arm carriage 08')]:
...
(out/'native-contacts.json').write_text(json.dumps(report, indent=2), encoding='utf-8')
