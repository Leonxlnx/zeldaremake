...
The actual stair check completed 660 frames up and 660 down without browser errors or reach clamps. It sampled 502/486 deformed sole points against rendered stair meshes: minimum gaps +2.66 mm ascending / −1.98 mm descending, with no sample below −20 mm. However, maximum knee flexion remains 162.35° up / 155.03° down and the largest descent root step is 60.37 mm. These are still posture/continuity issues, despite good sampled sole clearance. [Stair capture manifest](../2026-09-20T18-35-23-846Z-play-motion/manifest.json).
