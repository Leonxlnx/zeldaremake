...
for side in [-1,1]:
    ...
    ellipsoid('Iris rim '+str(side),(x,ey-.001,z),(.0169,.0018,.0150),irisrim,48,20)
    ellipsoid('Iris teal '+str(side),(x,ey-.0026,z),(.0160,.0012,.0143),iris,48,20)
    ellipsoid('Pupil '+str(side),(x,ey-.004,z),(.0078,.001,.0077),pupil,32,20)
...
for i,pts in enumerate(locks):
    rad=[.025,.034,.033,.024,.025,.024][i] if i<6 else .023
