...
try{
  ...
  for(const scenario of flatVideo?['flat-transitions']:descentDetail?['stairs-down']:['flat-transitions','stairs-up','stairs-down']){
    ...
    const chunk=flatVideo?2:descentDetail?10:30;
