 ...
 * verge, 5.3–6 m from camera D, to a 1.35 m landing beside the signpost; see layout.ts).
 ...
 * stands 0.75 m beyond them beside the landing and frame B fixes its board (round 31's first
 ...
 * the 1.3 m landing needs, flagged damp out to `dampReach` m.
