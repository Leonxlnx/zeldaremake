 ...
 * to red-brown. (1.85, 1.42, 0.92) → (1.86, 1.36, 1.01): r/g 1.30 → 1.37, b/g 0.65 → 0.74, the
 * map-weighted luminance kept (0.2745 → 0.2758).
 */
export const WOOD_TINT: [number, number, number] = [1.86, 1.36, 1.01];
