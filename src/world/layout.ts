...
export const LAYOUT = {
  ...
  stairs: [
    ...
    { id: 'north', base: [-2.7, 0, -13.5], dir: [-0.1, -1], steps: 4, rise: 0.3, tread: 0.5, width: 2.6 },
  ] as StairDef[],
  ...
  houses: [
    { id: 'saria', position: [11.5, 1.2, -15.5], trunkRadius: 3.1, facing: [-0.6, 0.8], roofHeight: 5.6, lanterns: 3 },
    { id: 'upper', position: [23, 5.4, -9], trunkRadius: 2.7, facing: [-1, 0.15], roofHeight: 5.0, lanterns: 2 },
  ] as HouseDef[],

  signposts: [
    { id: 'saria-sign', position: [6.8, 1.2, -12.2] as [number, number, number], facing: [-0.55, 0.83] as [number, number] },
  ],
  ...
  lanternBranch: {
    from: [-13.5, 5.2, -2.5] as [number, number, number],
    to: [-4.5, 4.6, -3.2] as [number, number, number],
    lanterns: 3,
  },

  logArch: {
    /** giant hollow fallen log lying roughly east-west, the far landmark of shot D */
    position: [4, 2.0, -52] as [number, number, number],
    radius: 3.4,
    length: 22,
    yawDeg: 12,
    lanterns: 2,
  ...
  heroBoulders: [
    { id: 'terrace-boulder', position: [-5.5, 1.2, -19] as [number, number, number], radius: 2.2 },
    { id: 'shot-d-boulder', position: [-6.5, 0, 2.5] as [number, number, number], radius: 1.1 },
  ...
  giantTrees: [
    { id: 'lantern-tree', position: [-14.5, 2.6, -1.5], trunkRadius: 1.6, height: 26, limb: { dir: [1, -0.08], length: 10, height: 5.2 } },
  ...
  viewpoints: [
    { id: 'A_stairs', refSeconds: 1, label: 'The Stairs', position: [1.2, 1.75, 6.8], target: [9.6, 3.4, -3.6], fov: 46 },
    { id: 'B_house', refSeconds: 14, label: "Saria's House", position: [-1.6, 1.8, 6.4], target: [5.2, 2.3, -12.5], fov: 46 },
    { id: 'C_lookback', refSeconds: 46, label: 'Look Back', position: [3.2, 1.8, -9.5], target: [-5.5, 2.5, 3.5], fov: 46 },
    { id: 'D_log', refSeconds: 56, label: 'The Log Arch', position: [1.0, 1.9, -5.0], target: [3.2, 3.0, -48], fov: 48 },
