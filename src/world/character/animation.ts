 ...
 */
export const GAIT_SPEED: Record<Gait, number> = { idle: 0, walk: 1.6, run: 1.2 / (28 / 60), stairs: 1.1 };
 ...
 * the actual speed. Running covers 1.20 m in about 0.55 s (220 steps/min), matching
 * the shorter planted stride and rear heel recovery to this character's leg length.
 */
export const PLAYER_SPEED: Record<Gait, number> = { idle: 0, walk: 1.2, run: 2.2, stairs: 1.1 };
