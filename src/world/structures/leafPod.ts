/** Original Astra leaf-pod implementation reused from 45ed76dce4a2551d60074c25bf7d21f10e2124b8.
 * Selected only by optional lantern-post callers; shared house/branch pods remain unchanged.
 */
/**
...
import type { LanternRig, LanternKind } from './lantern';
...
export function buildLeafLantern(hook: Vector3, cordLength: number, mats: StructureMaterials, rng: Rng, scale = 1, kind: LanternKind = 'orange'): LanternRig {
