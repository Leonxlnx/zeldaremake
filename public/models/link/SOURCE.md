...
Current delivery: **46dcbcc36490ee5c86f6d9eb28d58d1743f60cfab02bb0c899b8388b6eda3de0**, 51,125,832 bytes. Four walk shoulder/elbow rotation channels are derived from Quaternius Universal Animation Library Standard `Walk_Loop` (CC0), phase-aligned to the retained legs and fitted in Blender to this rig's arm bend plane. The donor's elbow variation replaces the fixed elbow pose; carriage is less forward. Right sleeve clearance is 2.5 degrees; the left retains its original plane because the strap is asymmetric. Wrist tracks, other clips, body motion, geometry, materials and the original binary prefix are preserved.
