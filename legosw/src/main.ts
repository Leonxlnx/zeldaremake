...
interface Api {
  ...
  probeActors(t: number): ReturnType<Film['probeActors']> | null;
  probeLasers(t: number): ReturnType<Film['probeLasers']> | null;
...
window.__LSW__ = {
  ...
  probeActors: (t) => film?.probeActors(t) ?? null,
  probeLasers: (t) => film?.probeLasers(t) ?? null,
