# Historical Astra environment working notes

Frozen during the ancestry merge of Fable 1cc8f51. These notes include superseded plans; current scope and known issues belong in `.agents/astra-environment.md`.
...
PR2 comment 5646560839 announces the own-branch ancestry merge of published Fable 1cc8f51 and
subsequent near-column floor-grain trial. The read-only merge found only equivalent moss-normal
and semantic-id conflicts; take Fable's explanatory comments/id arrangement while preserving
all current functional fixes, props, light and capture work. His log, ledger and references come
across intact. No PR2/main merge or change to his branch. The next column candidate is confined
to trees/materials.ts, reuses the filtered bark sample and preserves f630 non-instanced treatment.
...
## Last updated
2026-09-12T14:39:33.231961+00:00
