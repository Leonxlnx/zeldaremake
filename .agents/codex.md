...
Lifecycle review 2026-09-09T12:21:17.520690+00:00: vegetation dispose currently releases only materials; assembler delegates cleanup to each system. Adding disposal of all active/dormant LOD geometries and InstancedMesh buffers, idempotently, with an actual-factory disposal-event regression. No shared assembler change.

Further LOD review 2026-09-09T12:22:45.634986+00:00: actual fern centerlines shift up to33.1cm and bush stem tips46.3cm high-to-mid from detail-dependent RNG. Implementing canonical high-detail parameter consumption with subset emission for medium only, preserving existing high geometry hashes and keeping low unchanged. Separate agents own fernGeometry and bushGeometry function scopes; parent owns index cleanup. Lifecycle regression passes638 disposal events exactly once, including240 dormant grass LODs.
