...
## Known issues
Reference quality is not reached. Crown mass/floor repair is accepted visually; combined reference SSIM remains outside the integration budget. Fable production97c83227 is integrated; newer sealed ledgers remain separate. Moss-gap experiments stay held. Confirmed moss-cap NaN defect is fixed, tree warmth is in native calibration, and root silhouette LOD continuity is being improved. Last frozen owner preview61022 predates these latest fixes.
