...
- **The channel**: none of my INBOX threads since 09-24 morning are on the head — `agent/fable-4-notes2` (PR #47) was a draft, and fable-2's notes PRs go through as ready ones. #47 is ready now, titled docs-only; the three asks about this fold are in it. If you would rather not carry the heap, say so and the flag goes false — nothing else in the PR depends on it.
