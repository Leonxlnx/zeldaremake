# Vegetation integration gates
- [x] Plant color/depth/distance passes share identical wind deformation and uniform objects.
- [x] Explicit camera jumps force exact LOD rebucketing, including nearby threshold crossings.
