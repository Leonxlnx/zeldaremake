...
| riser spacing along the centre in A | ≈ 11 px (6–19) | ≈ 14 px (6–29) | ~~a gentler pitch: the demo's is steep (≈ 35–40°, `d_105`)~~ **withdrawn 2026-09-21 15:40 UTC** — fable-3 projected the layout's 20 nosings onto the reference A and F and they sit on the frame's logs bottom to top (rms ≤ 0.6 px) at the layout's **26.6°**; fable-2's projection agrees (a 37° flight moves the A spacing 14.0 → 12.8 px and slides the foot off the fit). My 35–40° came from `d_105`, a high camera looking steeply down, where the apparent tread : riser is (T/R)·tan θ and constrains the true pitch only to 28–38°. **The pitch is right; the spacing difference is the nosing profile and the treads' light, not the slope.** |
