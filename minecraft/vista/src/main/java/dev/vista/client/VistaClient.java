...
public final class VistaClient implements ClientModInitializer {
    ...
    public static List<String> debugLines() {
        ...
        return List.of(
                String.format("[Vista] %d selected, %d visible, %d draws (%d translucent), %.2fM quads, frame %.2f ms (prep %.2f ms)",
                        r.statSelected, r.statVisible, r.statCommands, r.statTransCommands, r.statQuadsDrawn / 1e6, r.statCpuMs, r.statPrepMs),
